...
{
    public partial class Add_Knight_CategoryForm : Form
    {
        private readonly string PK;
        readonly bool edit;
        public Add_Knight_CategoryForm()
        {
            InitializeComponent();
        ...
        public Add_Knight_CategoryForm(string Knight_Category, int Min_Weight, int Max_Weight, int Min_Visited_Tourniments, string Sex) : this()
        {
            knight_CategoryTableAdapter.Fill(_All_Ukrainian_knightly_tournamentDataSet.Knight_Category);
        ...
        private void Add_Knight_CategoryForm_Load(object sender, EventArgs e)
        {
